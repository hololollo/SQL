...
-- 제약조건 없이 기본키 생성(단점 : 변경하기 까다롭다)
alter table member modify id varchar(12) primary key;

-- default 대신 current timestamp 쓸 수 있음.
...
-- 도서테이블 만들기 auto_increment : sequence를 쓰지 않아도 된다!
create table book(bookid int auto_increment primary key, bookkind varchar(3) not null, booktitle varchar(100) not null, bookprice int not null, bookcount int not null, author varchar(100), pubcon varchar(40), pubdate datetime);
desc book;
